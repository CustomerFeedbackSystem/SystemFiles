// Validate Ticket Submit Form
function comp_hide()
{
if (document.comp.mo_phone.value == "Your Mobile Number")
document.comp.mo_phone.value = "07";
}

function comp_show()
{
if ((document.comp.mo_phone.value == "") || (document.comp.mo_phone.value == "07") )
document.comp.mo_phone.value = "Your Mobile Number";
}
...
//CAPTCHA WHERE APPLICABLE
	...
	function reloadCaptcha()
	{
		...
		/* this is just a simple reload; you can safely remove it; remember to remove it from the image too */
	function reloadCaptcha_2()
	{
		document.getElementById('captcha_2').src = document.getElementById('captcha_2').src+ '?' +new Date();
	}
...
(function($) {
    ...
    $.fn.orbit = function(options) {
        ...
        var defaults = {  
            ...
            advanceSpeed: 10000, //if auto advance is enabled, time between transitions 
