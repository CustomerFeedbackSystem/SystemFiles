...
<div>
		   ...
		   if (isset($_SESSION['success_message']))
		   	{
			echo "<div class=\"msg_success\" style=\"margin:15px 0px 0px 0px\">".$_SESSION['success_message']."</div>";
		   ...
		   ?>
			...
			if ($num_flow>0)
				...
				do {
			?>
            <div class="border_thin" style="text-align:center; padding:10px 0px ">
                	...
                	<tr>
                       ...
                       <table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						if ($fet_flow['idwfsymbol']!=1){ //if not the start event, then you can delete
							...
							if ($fet_wf['wfstatus']==1)
								{
						?>
                        <a onclick="return confirm('<?php echo $msg_prompt_nodelactive?>')" href="#" id="button_delete_vsmall"></a>
                        <?php } else { ?>
                        <a onclick="return confirm('<?php echo $msg_prompt_delete;?>')" href="index.php?uction=edit_workflow&amp;saction=delete_step&amp;resolv=<?php echo $fet_flow['idwftskflow'];?>" id="button_delete_vsmall"></a>
                        <?php
							}
						}
						?>
