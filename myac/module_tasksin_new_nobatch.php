...
WHERE ".$qry_recepient." AND wftskstatustypes_idwftskstatustypes=0 AND wftskstatusglobal_idwftskstatusglobal=1 ORDER BY ".$_SESSION['order_field']." ".$_SESSION['order_logix']."";
...
?>
     ...
     <tr>
    	<td colspan="7" class="text_body" bgcolor="#E2E2E2">
        ...
        <table border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td class="text_body">
                        <strong>
                        <select name="sel_action" style="padding:1px">
                        <option value="" selected="selected"> -- Select Action -- </option>
                        <option value="assign">Pass On Selected Tasks</option>
                        </select>                                            
                        </strong>
                        </td>
                        <td>
                       <input type="hidden" value="2" name="mod" />
                       <!-- <input type="hidden" value="20002" name="submod" />
                        <input type="hidden" name="uction" value="view_submod" />-->
                        <input type="hidden" value="mass_assign" name="formaction" />
...
?>>
		...
		if ($_SESSION['delegated']==1)
			{
			echo "<td width=\"10\"><a href=\"#\" style=\"text-decoration:none\" class=\"tooltip\"><img src=\"../assets_backend/icons/icon_lock.gif\" border=\"0\" align=\"absmiddle\" style=\"padding:2px\" /><span>&nbsp;&nbsp;You have currently Delagated all your Tasks to ".$_SESSION['delegated_tasks_to']."</span></a></td>";
			}
		//DELEGATED IN
		if (($delegated_to_me==1) &&  ($fet_delegated['idusrrole_from']==$row_rs_list['usrrole_idusrrole']) )
			{
			echo "<td width=\"10\"> <img title=\"C/O ".$fet_delegated['usrrolename']." - ".$fet_delegated['utitle']." ".$fet_delegated['fname']." ".$fet_delegated['lname']." \" src=\"../assets_backend/icons/icon_co.gif\" border=\"0\" align=\"absmiddle\" style=\"padding:2px\" /></td>";
			}
		
		if ($row_rs_list['wfactorsgroup_idwfactorsgroup']==$_SESSION['idwfgroup_val'])
			{
			echo "<td width=\"10\"><img title=\"Group Task \" src=\"../assets_backend/icons/icon_group.gif\" border=\"0\" align=\"absmiddle\" style=\"padding:2px\" /></td>";
			}
		?>
        <td>
        ...
        <td class="tbl_data" style="padding:0px; ">&nbsp;</td>
	</tr>
<?php 
