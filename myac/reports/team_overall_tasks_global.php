...
if($_SESSION['exportid']==1)
	...
	header("Content-Disposition: attachment; filename=team_overall_tasks_global.xls");
...
<div style="padding:10px">
    ...
    $sql_dpt="SELECT usrrole.usrteamzone_idusrteamzone,userteamzonename FROM wftasks 
		...
		do	{ ?>
            <tr>
                <td colspan="4" class="tbl_data">
                    <span class="text_body_large"><?php echo $fet_dpt['userteamzonename'];?></span>
                </td>
            </tr>
            ...
            WHERE usrrole.usrteamzone_idusrteamzone=".$fet_dpt['usrteamzone_idusrteamzone']."
            ...
            <tr>
				...
				AND usrrole.usrteamzone_idusrteamzone=".$fet_dpt['usrteamzone_idusrteamzone']."
