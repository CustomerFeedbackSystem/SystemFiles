...
<div style="padding:10px">
    ...
    $sql="SELECT tktin.usrteamzone_idusrteamzone,userteamzonename,count(idtktinPK) as pending
	FROM tktin
    ...
    <table border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="tbl_data">
				...
				/*$sql_tot="SELECT count(idtktinPK) as tot FROM tktin
				INNER JOIN usrteamzone ON tktin.usrteamzone_idusrteamzone=usrteamzone.idusrteamzone
...
<?php */?>	        <td class="tbl_data">
				...
				/*$sql_ovd="SELECT count(idtktinPK) as ovd FROM tktin
				INNER JOIN tktcategory ON tktin.tktcategory_idtktcategory=tktcategory.idtktcategory 
				INNER JOIN usrteamzone ON tktin.usrteamzone_idusrteamzone=usrteamzone.idusrteamzone
				WHERE tktin.usrteamzone_idusrteamzone='".$fet['usrteamzone_idusrteamzone']."' 
				AND TIME_TO_SEC(TIMEDIFF(NOW(),tktin.timereported)) > tktcategory.tat 
				AND tktstatus_idtktstatus<4";*/
				...
				if ($num_ovd>0) 
					...
					echo number_format($fet_ovd['ovd'],0);
		...
		$total_pending_BTAT=($total_pending_BTAT+$fet_ovd['ovd']);
        ...
        <tr>
        	...
        	<td class="tbl_h" style="background-color:#66FFFF; color:#000000;">
            	<?php echo number_format($total_pending_BTAT,0); ?>
            </td>
        </tr> 
    </table>    
    <?php    
