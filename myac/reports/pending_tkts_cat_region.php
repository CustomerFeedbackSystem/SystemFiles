...
if($_SESSION['exportid']==1)
	...
	header("Content-Disposition: attachment; filename=pending_tkts_cat_region.xls");
    ...
    <table border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td class="tbl_data">
				<?php 
				//Get total received for this category
				$sql_pen="SELECT count(idtktin) as totpen FROM tktin
				WHERE tktin.tktcategory_idtktcategory='".$fet['tktcategory_idtktcategory']."' 
				...
				echo number_format($fet_pen['totpen'],0);?>            
           	</td>
	        <td class="tbl_data">
				<?php 
...
*/
		...
		$total_pending=($total_pending+$fet_pen['totpen']);
