...
<div style="padding:0px 0px 0px 5px"><h2> Report Center</h2></div>
...
<tr>
      ...
      <td width="141" height="30" class="tbl_sh">Number</td>
        ...
        <tr>
        	<td height="35" class="tbl_data"><a href="../myac/index.php?view=29&amp;page=&amp;mod=5&amp;submod=29&amp;uction=view_submod"><strong>Tickets Received</strong>  ( Past Week )</a></td>
          <td height="35" class="tbl_data">
            <?php
			$sql_received="SELECT count(*) as total_in FROM tktin WHERE date(timereported) >'".$seven_days_ago_notime."'";
        ...
        <tr>
        	<td height="35" bgcolor="#FBFBFB" class="tbl_data"><a href="../myac/index.php?view=66&amp;page=&amp;mod=5&amp;submod=66&amp;uction=view_submod">Tickets Currently Pending</a></td>
          <td height="35" bgcolor="#FBFBFB" class="tbl_data">
          <?php
			$sql_pending="SELECT count(*) as total_pending FROM tktin WHERE tktstatus_idtktstatus<4 ";
		  ...
		  <td height="35" bgcolor="#FBFBFB" class="tbl_data">
            <?php
			$sql_pendingwt="SELECT count(idtktinPK) as total_pendingwt,TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)),tktcategory.tat  FROM tktin
			INNER JOIN tktcategory ON tktin.tktcategory_idtktcategory=tktcategory.idtktcategory 
			WHERE TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) <= tktcategory.tat 
        ...
        <tr>
        	<td height="35" class="tbl_data"><a href="../myac/index.php?view=67&amp;page=&amp;mod=5&amp;submod=67&amp;uction=view_submod"><strong>Tickets Closed</strong> ( Past Week )</a><sup> [ 1 ]</sup></td>
          <td height="35" class="tbl_data">
            <?php
			$sql_closed="SELECT count(*) as total_closed FROM tktin WHERE date(timeclosed) >='".$seven_days_ago_notime."'  AND tktstatus_idtktstatus>3";
...
//			$sql_closedwt="SELECT count(*) as total_closedwt FROM tktin WHERE tktstatus_idtktstatus>3 AND timereported>='".$timenowis."' AND timedeadline>=timeclosed ";
			$sql_closedwt="SELECT count(*) as total_closedwt FROM tktin 
			INNER JOIN tktcategory ON tktin.tktcategory_idtktcategory=tktcategory.idtktcategory
			WHERE tktstatus_idtktstatus>3 AND timeclosed >='".$seven_days_ago."' AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) < tktcategory.tat  ";			
    	...
    	<tr>
        	...
        	<ol>
          	<li class="border_bottom">
				<?php $lbl_rpt_13="Global Compliance Performance Report ( By Region )"; ?>
                <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==13)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=13#btm"><?php echo $lbl_rpt_13;?></a>
                <br />
            ...
            <li class="border_bottom">
				<?php $lbl_rpt_12="Daily Report: Global Complaints Resolution Rate ( By Region )"; ?>
                <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==12)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=12#btm"><?php echo $lbl_rpt_12;?></a>
                <br />
            ...
            <li class="border_bottom">
			<?php $lbl_rpt_6="Monthly Report : Global Complaints Resolution Compliance ( By Region ) ";?>
           <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==6)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=6#btm">
           ...
           <?php echo $lbl_rpt_6;?></a>
            ...
            <li class="border_bottom">
				<?php $lbl_rpt_4="Monthly Report : Complaints Resolution Compliance ( ".$_SESSION['MVGitHub_userteamzone']." ) ";?>
                 <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==4)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=4#btm">
        	...
        	<ol>
          	<li class="border_bottom">
				<?php $lbl_rpt_23="Global Secondary Tickets Report ( By Region )"; ?>
                <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==23)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=23#btm"><?php echo $lbl_rpt_23;?></a>
                <br />
                <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==23)) { ?>
                <form method="get" action="reports/secondary_tkts_global.php" target="_blank" style="margin:0px">
                <table border="0">
                    <tr>
                        <td><input name="timestart" type="text" id="timestart" onClick="displayDatePicker('timestart');" value="<?php if (isset($_SESSION['timestart'])) { echo $_SESSION['timestart']; } ?>" size="10" readonly="readonly"> 
                                    <img src="../assets_backend/btns/cal.gif" alt="Pick a date" width="30" height="30" border="0" align="absmiddle" onClick="displayDatePicker('timestart');">                        </td>
						...
						<td>	
                        <input type="hidden" name="reportname" value="<?php echo $lbl_rpt_23;?>" />
                        <input type="submit" value="Run Report" />
                        </td>                       
                    </tr>
                </table>
            ...
            <li class="border_bottom">
			<?php $lbl_rpt_25="Average Ticket Resolution Time ( By Region )";?>
           	<a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==25)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=25">
          	<!--  <a href="#" style="color:#CCCCCC">-->
           <?php echo $lbl_rpt_25;?></a>
            <br />
            <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==25)) { ?>
            <form method="get" action="reports/average_ticket_resolution.php" target="_blank" style="margin:0px">
            <table border="0">
                <tr>
                    <td>
                    	<input name="timestart" type="text" id="timestart" onClick="displayDatePicker('timestart');" value="<?php if (isset($_SESSION['timestart'])) { echo $_SESSION['timestart']; } ?>" size="10" readonly="readonly"> 
                    ...
                    <td>	
                        <input type="hidden" name="reportname" value="<?php echo $lbl_rpt_25;?>" />
                        <input type="submit" value="Run Report" />
                    </td>                       
            	</tr>            
            </table>
    ...
    <div>
        <ol>
            ...
            <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==11)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=11#btm"><?php echo $lbl_rpt_11;?></a>
            <br />
            ...
            <li class="border_bottom">
            <?php $lbl_rpt_14="Overall Tasks Report per Individual Grouped ( By Region )"; ?>
            <a class="text_body" <?php if ((isset($_SESSION['reportid'])) &&  ($_SESSION['reportid']==14)) { echo "style=\"text-decoration:none;color:#cc0000;font-weight:bold\""; } ?> href="<?php $_SERVER['PHP_SELF'];?>?reportid=14#btm"><?php echo $lbl_rpt_14;?></a>
            <br />
