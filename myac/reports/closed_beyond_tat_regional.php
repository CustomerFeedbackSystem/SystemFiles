...
<div style="padding:10px">
    ...
    <div class="hidden">
            <table border="0" width="100%">
                ...
                <a href="#" style="color:#CCCCCC" class="text_body_mod">Switch to Graph</a>                </span>                    </td>
                    ...
                    <form method="post" action="../reports/print_report.php" name="excel" target="_blank">
    ...
    (SELECT count(*) FROM tktin WHERE usrteamzone_idusrteamzone=".$_SESSION['MVGitHub_userteamzoneid']." AND tktcategory_idtktcategory=idtktcategory 
	AND (tktin.timereported>'".$_SESSION['timestart']."' OR tktin.timereported='".$_SESSION['timestart']."')  
	AND (tktin.timereported<'".$_SESSION['timestop']."' OR tktin.timereported='".$_SESSION['timestop']."') as TTL 
    FROM tktin 
    ...
    AND ( tktin.timeclosed>'".$_SESSION['timestart']."' OR tktin.timeclosed='".$_SESSION['timestart']."' )
    AND (timeclosed<'".$_SESSION['timestop']."' OR timeclosed='".$_SESSION['timestop']."')
    ...
    <table border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
            <td class="tbl_data">
            <strong><?php echo $fet['tktcategoryname'];?></strong>
            </td>
            <td class="tbl_data">
            <?php echo $fet['TTL'];?>
            </td>
