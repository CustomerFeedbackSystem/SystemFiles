...
//		echo "SELECT datediff('".$timenowis."',usrac.lastaccess) as days, lastaccess FROM usrac WHERE usrrole_idusrrole=".$row_rs_tsks['usrrole_idusrrole']."";
...
<?php } else { echo "<div class=\"msg_warning\">No Records Found</div>"; }//only show if there is a record els?>
<?php
