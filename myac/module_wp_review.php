...
<?php
$sql_wps="SELECT idwpheader,yearfrom,yearto,utitle,fname,lname,nstatus,usrteamname,wpheader.enteredon,wpheader.modifiedon FROM wpheader
...
WHERE notestatus.tbl_name='wpheader' ORDER BY yearfrom DESC ";
...
<table border="0" cellpadding="5" cellspacing="0" width="80%">
	...
	<tr>
        ...
        <td height="30" class="tbl_h2">
        <?php echo $lbl_createdon;?>        </td>
         <td height="30" class="tbl_h2">
        <?php echo $lbl_modifiedon;?>        </td>
    </tr>
    <?php
...
?>>
       ...
       <?php echo $fet_wps['nstatus'];?>
        ...
        <td class="tbl_data">
        <?php echo date("D, M d, Y H:i",strtotime($fet_wps['enteredon'])); ?>
        </td>
        <td class="tbl_data">
        <?php if (($fet_wps['modifiedon']!='0000-00-00 00:00:00') && ($fet_wps['modifiedon']!=''))
		{ 
		echo date("D, M d, Y H:i",strtotime($fet_wps['modifiedon'])); 
		} else {
		echo "---";
		}
		?>
