...
<label for="<?php echo $row_rs_list['idwftasks']; ?>">		 
		...
		<td class="tbl_data" <?php if ($row_rs_list['wftskstatustypes_idwftskstatustypes']==0) { echo "style=\"font-weight:bold\""; } ?>>
        <a href="go_to_taskhistory.php?tkt=<?php echo $row_rs_list['tktin_idtktin']; ?>&amp;tktcat=<?php echo $row_rs_list['tktcategory_idtktcategory']; ?>&amp;title=<?php echo $row_rs_list['refnumber']; ?>&amp;tabview=1&amp;team_member=9&amp;keepThis=true&amp;TB_iframe=true&amp;height=475&amp;width=<?php echo $_SESSION['tb_width'];?>&amp;inlineId=hiddenModalContent&amp;modal=true" id="thickBoxLink" class="thickbox">
		<?php 
...
<?php
//echo "<div style=\"color:#ffffff\">".$query_rs_list."<div>";
