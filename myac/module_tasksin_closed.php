...
WHERE tktin.idtktinPK=tktin_idtktin) as batch_number_verb
 FROM wftasks INNER JOIN usrrole ON wftasks.sender_idusrrole=usrrole.idusrrole INNER JOIN usrac ON wftasks.sender_idusrac=usrac.idusrac INNER JOIN tktin ON wftasks.tktin_idtktin=tktin.idtktinPK WHERE wftasks.usrrole_idusrrole=".$_SESSION['MVGitHub_iduserrole']." AND wftskstatustypes_idwftskstatustypes<6 AND ((wftskstatustypes_idwftskstatustypes>1 AND sender_idusrrole!=".$_SESSION['MVGitHub_iduserrole'].") OR (wftskstatustypes_idwftskstatustypes=1)) ORDER BY ".$_SESSION['order_field']." ".$_SESSION['order_logix']."";
...
<div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    	<tr>
        	<td width="50%" class="bg_section"><?php echo $lbl_completed;?>
            <a href="#" style="text-decoration:none;" class="tooltip"><img src="../assets_backend/icons/help.gif" border="0" align="absmiddle" /><span><?php echo $msg_tip_completed;?></span></a></td>
...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0">
        ...
        <td width="15%" class="tbl_h2"><?php //echo $lbl_timetaken;?></td>
        <td class="tbl_h2">&nbsp;</td>
	</tr>  
    <?php do { ?>
      <tr <?php 
...
/*		//deciding the color to use
		if ($row_rs_list['timedeadline'] > date("Y-m-d H:i:s",time(strtotime($row_rs_list['timeactiontaken']))) )
			{
