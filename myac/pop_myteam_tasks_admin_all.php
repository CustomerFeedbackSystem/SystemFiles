		...
		if ($count > 0) //if a record has been chosen
			{
				...
				window.location='pop_myteam_tasks_admin.php?tabview=4';
				</script>                
                <?php
				exit;
    	...
    	<td colspan="4" class="tbl_data">
       			<table border="0" cellpadding="2" cellspacing="0" bgcolor="#E2E2E2">
                    <tr>
                        ...
                        <option value="transfer">Transfer From : <?php echo $fet_memberdetails['usrrolename'];?> </option>
                        </select>                                            
                        </strong>
                        </td>
                        <td>
