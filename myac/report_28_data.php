...
// generate  data
$sql_data="SELECT SUM(tktin.tktcategory_idtktcategory) as tkts, timereported FROM tktin
INNER JOIN tktcategory ON tktin.tktcategory_idtktcategory=tktcategory.idtktcategory 
WHERE idtktin>0 ".$_SESSION['tktzone']." ".$_SESSION['tktstatus']." ".$_SESSION['tktchannel']." ".$_SESSION['filter_category']." GROUP BY DATE(timereported)";
