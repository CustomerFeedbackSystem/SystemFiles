...
<div>
    <div >
    <form action="" name="search_tasks" method="get">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    	<tr>
        	<td width="50%" class="bg_section"><?php echo $lbl_overdue;?></td>
