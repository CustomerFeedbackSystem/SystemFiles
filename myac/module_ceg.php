						...
						$tkts_total=0;
                         ...
                         for ($k=$day_val; $k > 0; $k--)  
                          ...
                          <td valign="top" class="tbl_data">
                                <?php 
								$ttsec_k=(86400*$k);
								$ttsecmin_k=($ttsec_k-86400);
								
								//echo "<span style=\"color:#ff0000\">".$ttsec_k."</span>";
								//echo "<span style=\"color:#ff0000\">".$k."</span>";
								//per category
								...
								if ($k > 9)
									...
									AND	TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) > 777600
									...
									timeclosed='0000-00-00 00:00:00' 
									AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) > tktcategory.tat
									AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) >  ".$ttsecmin_k."
									AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) <=  ".$ttsec_k."
									AND	tktin.tktcategory_idtktcategory=".$fet_category['idtktcategory']." 
									AND tktstatus_idtktstatus < 4 ");
                   ...
                   <tr>
						...
						for ($j=$day_val; $j > 0; $j--)  
							...
							if ($j > 9)
									...
									AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) > tktcategory.tat
									AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) > ".$ttsecmin_j."
									AND TIME_TO_SEC(TIMEDIFF('".$timenowis."',tktin.timereported)) <= ".$ttsec_j."
									AND tktstatus_idtktstatus < 4 ");
									}
...
if ($_SESSION['parenttabview']==2)
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%">
                        	<tr>
                            	<td height="30" class="table_header"><a href="?parentviewtab=1">&laquo; Back to main</a></td>
                  <?php
                          ...
                          <?php
							...
							if ($_SESSION['odue'] > 9)
								{
								$_SESSION['var_dl']=777600; //time deadline
								...
								$_SESSION['var_dl']=($_SESSION['odue']*86400); //time deadline
								$_SESSION['var_dl_min']=($_SESSION['var_dl']-86400); //time deadline min
                               ...
                               <strong> <?php echo $fet_cats['tktcategoryname'];?></strong>
								...
								//echo $_SESSION['var_dl'];
									...
									//loop through the region data below for the 6 or so regions if regions is set to all
											...
											AND	tktin.usrteamzone_idusrteamzone=".$fet_reglbl['idusrteamzone']." ");
