...
<div style="padding:0px 5px 100px 5px">
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" >
    	<tr>
            ...
            <td width="33%">
            <form method="get" action="" name="filter_usrprofile" style="margin:0px;background-color:#f5f5f5; padding:5px;">
               ...
               Filter : <select name="filter_region" onchange="this.form.submit();">
            ...
            <td width="33%">
             <form method="get" action="" name="find_usrprofile" style="margin:0px; padding:3px; background-color:#f5f5f5">
    ...
    <table border="0" cellpadding="2" cellspacing="0" width="100%" id="hi">
		...
		INNER JOIN usrteamzone ON sysprofiles.usrteamzone_idusrteamzone=usrteamzone.idusrteamzone 
		WHERE usrteamzone.usrteam_idusrteam=".$_SESSION['MVGitHub_idacteam']." ".$_SESSION['qry_filter_global']." ORDER BY userteamzonename,sysprofile ASC";
