...
var FCK =
{
	...
	{
		this.TempBaseTag = FCKConfig.BaseHref.length > 0 ? '<base href="../../../../../myac/fckeditor/editor/_source/internals/' + FCKConfig.BaseHref + '" _fcktemp="true"></base>' : '' ;
		...
		if ( FCK.EditMode == FCK_EDITMODE_WYSIWYG )
		{
			...
			if ( FCKConfig.FullPage )
			{
				...
				if ( FCKBrowserInfo.IsIE )
					...
					sHtml = '<link href="../../../../../myac/fckeditor/editor/_source/internals/' + FCKConfig.FullBasePath + 'css/fck_showtableborders_gecko.css" rel="stylesheet" type="text/css" _fcktemp="true" />' ;

				sHtml += '<link href="../../../../../myac/fckeditor/editor/_source/internals/' + FCKConfig.FullBasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" />' ;
			...
			else
			{
				...
				sHtml +=
					...
					'<link href="../../../../../myac/fckeditor/editor/_source/internals/' + FCKConfig.FullBasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" />' ;
...
function _FCK_GetEditorAreaStyleTags()
{
	...
	for ( var i = 0 ; i < aCSSs.length ; i++ )
		sTags += '<link href="../../../../../myac/fckeditor/editor/_source/internals/' + aCSSs[i] + '" rel="stylesheet" type="text/css" />' ;
