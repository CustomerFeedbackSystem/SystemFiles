...
FCKIcon.prototype.CreateIconElement = function( document )
{
	...
	if ( this.Position )		// It is using an icons strip image.
	{
		...
		{
			// <div class="TB_Button_Image"><img src="../../../../../myac/fckeditor/editor/_source/classes/strip.gif" style="top:-16px"></div>
		...
		{
			// <img class="TB_Button_Image" src="../../../../../myac/fckeditor/editor/_source/classes/spacer.gif" style="background-position: 0px -16px;background-image: url(../../../../../myac/fckeditor/editor/_source/classes/strip.gif);">
	...
	else					// It is using a single icon image.
	{
		...
		else
		{
			...
			// <img class="TB_Button_Image" src="../../../../../myac/fckeditor/editor/_source/classes/smiley.gif">
			eIcon = document.createElement( 'IMG' ) ;
