...
{
	document.write( '<script type="text/javascript" src="../../../../myac/fckeditor/editor/_source/' + this.FCKeditorPath + 'editor/_source/' + scriptPathFromSource + '" onerror="alert(\'Error loading \' + scriptPathFromSource);"><\/script>' ) ;
}
