...
INNER JOIN tktcategory ON tktin.tktcategory_idtktcategory=tktcategory.idtktcategory WHERE usrteamzone_idusrteamzone=".$_SESSION['MVGitHub_userteamzoneid']." GROUP BY tktin.tktcategory_idtktcategory";
