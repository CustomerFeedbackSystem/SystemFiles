...
<div>
    ...
    <div style="padding:15px 0px 0px 0px">
    	<div class="tab_area">
            ...
            <span class="tab_off"><a href="#" style="color:#666666; text-decoration:none"><?php echo $lbl_servmainlog;?></a></span>
    ...
    <form method="post" name="new_project" action="">
    	<table border="0" width="80%" cellpadding="3" cellspacing="0">
        	<tr>
            	<td class="tbl_data"><?php echo $lbl_assetname;?></td>
                <td class="tbl_data"><input type="text" name="assetname" maxlength="100" size="35"></td>
            </tr>
            <tr>
            	<td class="tbl_data"><?php echo $lbl_assetno;?></td>
                <td class="tbl_data"><input type="text" name="assetno" maxlength="100" size="15"></td>
            </tr>
            <tr>
            	<td class="tbl_data"><?php echo $lbl_assetgroup;?></td>
                <td class="tbl_data">
                <select name="assetg">
                <option value="">----</option>
                <?php
				$sql_assetg="SELECT idassetgroups,assetg FROM assetgroups";
				$res_assetg=mysql_query($sql_assetg);
				$fet_assetg=mysql_fetch_array($res_assetg);
					do {
					echo "<option value=\"".$fet_assetg['idassetgroups']."\">".$fet_assetg['assetg']."</option>";
					} while ($fet_assetg=mysql_fetch_array($res_assetg));
				?>
                </select>
                </td>
            </tr>
