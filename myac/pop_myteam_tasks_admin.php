...
if ( (isset($_SESSION['tabview_con'])) && (($_SESSION['tabview_con']==1) || ($_SESSION['tabview_con']==2)  || ($_SESSION['tabview_con']==3) || ($_SESSION['tabview_con']==4) ) )
	...
	$sql_memberdetails="SELECT idusrrole,usrrolename FROM usrrole 
	INNER JOIN usrteamzone ON usrrole.usrteamzone_idusrteamzone=usrteamzone.idusrteamzone 
	WHERE idusrrole=".$_SESSION['myteam_member']." AND usrteamzone.usrteam_idusrteam=".$_SESSION['MVGitHub_idacteam']." LIMIT 1";
...
$().ready(function() {
	$("#recepient_alt").autocomplete("findrole_alt_transfer.php", {
		width: 410,
		matchContains: true,
		//mustMatch: true
		//minChars: 0,
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		if ( (isset($display_content)) && ($display_content=="OK" ))
			{
			echo $fet_memberdetails['usrrolename'];
			}
		?>
		</div>
		</td>
			...
			if (isset($_SESSION['tabview_con']))
				{
					if ($_SESSION['tabview_con']==2)
						{
						require_once('pop_myteam_tasks_admin_all.php');
						}
