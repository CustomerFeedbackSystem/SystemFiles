...
<!--    <div class="text_small" style="padding:0px 0px 10px 0px">
    *Includes all Categories
	...
	if ($_SESSION['display_type']=="graph")
		...
		//open_flash_chart_object( '100%', '100%', 'report_28_data.php' );
		echo "<iframe src=\"flot/reports/categories/report_28_graph.php\" width=\"1000\" height=\"500\" scrolling=\"no\" frameborder=\"0\"></iframe> ";
		}
	?>
    </div>
    <?php
...
do {
        ...
        <tr>
        	<td class="tbl_data">
            <?php echo date("D, M d, Y",strtotime($fet_data['timereported'])); ?>
            </td>
            <td class="tbl_data">
