...
WHERE wftasks.tktin_idtktin=".$_SESSION['tktid']." ORDER BY createdon DESC";
...
$sql_tkt="SELECT senderphone,refnumber,tktdesc,timereported,tktchannelname,tktstatusname,tkttypename,tktcategoryname,locationname,sendername FROM tktin 
        ...
        <table border="0" width="100%" cellpadding="2" cellspacing="0">
        	<tr>
              ...
              <td width="70%" class="tbl_data">
               <strong> <?php echo $fet_tkt['refnumber'];?></strong>
               </td>
            </tr>
            <tr>
            	<td class="tbl_data">
                ...
                <td class="tbl_data">
                <strong> <?php echo $fet_tkt['tktcategoryname'];?></strong>
                </td>
            </tr>
            <tr>
            	<td class="tbl_data">
                ...
                <td class="tbl_data">
                <strong><?php echo date("D, M d, Y H:i",strtotime($fet_tkt['timereported'])); ?></strong>
                </td>
            </tr>
            <tr>
            	<td class="tbl_data">
                ...
                <td class="tbl_data">
                <strong><?php echo $fet_tkt['locationname']; ?></strong>
                </td>
            </tr>
            <tr>
            	<td class="tbl_data">
                ...
                <td class="tbl_data">
                <strong><?php echo $fet_tkt['tktdesc']; ?></strong>
                </td>
            </tr>
        </table>
        </div>
       ...
       <div>
       	<table border="0" width="100%" cellpadding="1" cellspacing="0">
        	<tr>
                ...
                <td  class="tbl_data">
                  <strong><?php echo $fet_tkt['sendername'];?></strong> </td>
            </tr>
            	<tr>
            	<td  class="tbl_data">
              <?php echo $lbl_mobile;?>
                ...
                <td  class="tbl_data">
                  <strong>0<?php echo substr($fet_tkt['senderphone'],3,6);?>***</strong> </td>
            </tr>
        </table>
       </div>
       </td>
